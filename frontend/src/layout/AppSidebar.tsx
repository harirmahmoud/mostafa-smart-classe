...
const navItems: NavItem[] = [
  ...
  },
  {
    name: "School Data",
    icon: <ListIcon />,
    subItems: resourceOrder.map((resource) => ({
      name: resource.label,
...
const AppSidebar: React.FC = () => {
          ...
          {nav.subItems ? (
            <button
              ...
              className={`menu-item group  ${
                activeSubmenu?.type === menuType && activeSubmenu?.index === index
                  ? "menu-item-active"
                  : "menu-item-inactive"
              } cursor-pointer ${
  ...
  const activeSubmenu = openSubmenu ?? pathnameOpenSubmenu;
